...
class ConsultantMapper(EntityMapper[Tuple]):
    ...
    def to_record(self, row: pd.Series) -> Tuple:
        # ID is auto-generated by database (gen_random_uuid())
        return (
            row["bullhornId"],
...
# Pre-defined schemas
# Note: 'id' is omitted - it's auto-generated by database (gen_random_uuid())
CONSULTANT_SCHEMA = TableSchema(
    table_name='"Consultant"',
    columns=("bullhornId", "firstName", "lastName", "email", "phone", "isActive", "createdAt", "updatedAt"),
...
CANDIDATE_SCHEMA = TableSchema(
    ...
    columns=(
        "bullhornId", "firstName", "lastName", "email", "phone", "skills",
    ...
    template="(%s, %s, %s, %s, %s, %s, %s::jsonb, %s::jsonb, %s, %s, NOW(), NOW(), NOW())",
)
...
POSITION_SCHEMA = TableSchema(
    table_name='"Position"',
    columns=(
        "bullhornId", "title", "description", "employmentType", "requiredSkills",
    ...
    template="(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, NOW(), NOW(), NOW())",
)
